...
$result = $conn->prepare("SELECT * FROM payments JOIN users ON payments.user_id = users.user_id LIMIT ?, ?");
                            ...
                            <table class="table table-sm table-bordered table-hover ">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="d-none"><?php echo $row['payment_id']; ?></td>
