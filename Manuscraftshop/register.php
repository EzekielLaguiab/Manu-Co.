...
if (isset($_POST['register'])) {
    ...
    try {
        $result = $conn->prepare("INSERT INTO users (first_name, last_name, user_email, user_password, verification_code, is_verified) 
                                   VALUES (?, ?, ?, ?, ?, 0)");
        $result->bind_param('sssss', $first_name, $last_name, $email, $hashed_password, $verification_code);
...
<?php endif; ?>
    ...
    <!-- sign up -->
    <section id="register" class="my-4 py-4">
