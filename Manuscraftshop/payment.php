...
<section id="payment" class="my-3 py-5 text-center container mx-auto">
    ...
    <div class="container mx-auto">
        ...
        <?php if ($order_status === "not paid") { ?>
            ...
            <form id="payment-form" action="complete_payment.php" method="GET">
                <div class="form-group">
                    <?php $amount = $_SESSION['order_total']; ?>
                    <p>Total payment: <b>P <?php echo $_SESSION['order_total']; ?></b></p>

                    <label for="transaction_id">Enter GCash Transaction ID: <span style="color: red;">*</span></label>
                    <input style="width: 40%;" type="text" class="form-control" id="transaction_id" name="transaction_id" required>
                ...
                <div class="form-group mt-2 text-center">
                    <button type="submit" name="updateAccount" class="btn btn-success">Confirm Transaction ID</button>
                </div>
                
            </form>
            <a href="acc.php">
                <input  class="btn " value="Visit Dashboard" type="submit">
            </a>
