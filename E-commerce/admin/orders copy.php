...
<?php if (isset($_GET['error']) && $_GET['error'] == 'Order not found'): ?>
...
<?php if (isset($_GET['message']) && $_GET['message'] == 'Order has been updated successfully'): ?>
    <script src="../assets/sweetalert2@11.js"></script>
    <script>
        Swal.fire({
            icon: "success",
...
<?php if (isset($_GET['message']) && $_GET['message'] == 'Order deleted successfully'): ?>
    <script src="../assets/sweetalert2@11.js"></script>
    <script>
        Swal.fire({
            icon: "success",
